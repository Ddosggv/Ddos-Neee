...
bot = telebot.TeleBot('7302251657:AAEpw6cv22sd1Z95kPjykSVkSFiWX42ct2g')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @ORBITXNOOB❄."
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /attack command.                                                                          DM TO BUY ACCESS:- @ORBITXNOOB")
...
Buy From :- @ORBITXNOOB
Official Channel :-https://t.me/Orbitconfigs'''
...
def welcome_start(message):
    ...
    response = f'''❄️ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴘʀᴇᴍɪᴜᴍ ʙᴏᴛ, {user_name}! ᴛʜɪs ɪs ʜɪɢʜ ǫᴜᴀʟɪᴛʏ sᴇʀᴠᴇʀ ʙᴀsᴇᴅ BOT. ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss.
...
3. MAKE SURE YOU JOINED https://t.me/+V5Ync3EKXtxlMDZl OTHERWISE NOT WORK
